...
//        }
        ...
        //the code for subtracting quantity on pressing the subtract button
        ImageButton subtractImageButton = findViewById(R.id.subtract_image_button);
        subtractImageButton.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        //the code for adding quantity on pressing the plus button
    ...
    private void saveInventory() {
        ...
        // Check if this is supposed to be a new product inventory
        ...
        values.put(InventoryEntry.COLUMN_SUPPLIER_PH_NO, supplierPhoneNumber);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        // all columns from the inventoryappstagetwo table
        String[] projection = {
                InventoryEntry._ID,
                ...
                InventoryEntry.COLUMN_SUPPLIER_PH_NO};

        // This loader will execute the ContentProvider's query method on a background thread
        return new CursorLoader(this,   // Parent activity context
                mCurrentInventoryUri,         // Query the content URI for the current inventory product
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            // Find the columns of product inventory attributes that we're interested in
            int nameColumnIndex = cursor.getColumnIndex(InventoryEntry.COLUMN_PRODUCT_NAME);
            int priceColumnIndex = cursor.getColumnIndex(InventoryEntry.COLUMN_PRICE);
            int quantityColumnIndex = cursor.getColumnIndex(InventoryEntry.COLUMN_QUANTITY);
            int supplierNameColumnIndex = cursor.getColumnIndex(InventoryEntry.COLUMN_SUPPLIER_NAME);
            int supplierPhoneColumnIndex = cursor.getColumnIndex(InventoryEntry.COLUMN_SUPPLIER_PH_NO);
    ...
    public void onLoaderReset(Loader<Cursor> loader) {
        ...
        mQuantityEditText.setSelection(0);// Set quantity to zero
    ...
    private void showUnsavedChangesDialog(
        ...
        builder.setNegativeButton(R.string.keep_editing, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                ...
                // and continue editing the inventory product.
                if (dialog != null) {
                    dialog.dismiss();
                }
            }
    ...
    private void showDeleteConfirmationDialog() {
        ...
        builder.setPositiveButton(R.string.delete, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                // User clicked the "Delete" button, so delete the product inventory.
                deleteInventory();
            }
        });
    ...
    private void deleteInventory() {
        // Only perform the delete if this is an existing inventory product.
        if (mCurrentInventoryUri != null) {
            // Call the ContentResolver to delete the inventory product at the given content URI.
            // Pass in null for the selection and selection args because the mCurrentInventoryUri
            // content URI already identifies the inventory product that we want.
