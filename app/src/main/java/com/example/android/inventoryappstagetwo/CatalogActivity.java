...
import com.example.android.inventoryappstagetwo.data.InventoryContract;
import com.example.android.inventoryappstagetwo.data.InventoryContract.InventoryEntry;

/**
 * Displays list of inventory that was entered and stored in the inventory app.
 */
public class CatalogActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inventoryListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                // For example, the URI would be "content://com.example.android.inventoryappstagetwo/inventoryappstagetwo/2"
                ...
                // Launch the {@link EditorActivity} to display the data for the current inventory product.
                startActivity(intent);
            }
        });
    ...
    private void insertInventory() {
        ...
        values.put(InventoryContract.InventoryEntry.COLUMN_PRODUCT_NAME, "Dummy Book Name");
        values.put(InventoryContract.InventoryEntry.COLUMN_PRICE, 19.99);
        values.put(InventoryContract.InventoryEntry.COLUMN_QUANTITY, 1);
        values.put(InventoryContract.InventoryEntry.COLUMN_SUPPLIER_NAME, "Dummy Supplier");
        values.put(InventoryContract.InventoryEntry.COLUMN_SUPPLIER_PH_NO, 1234567890);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        String[] projection = {
                ...
                InventoryContract.InventoryEntry.COLUMN_SUPPLIER_PH_NO};
